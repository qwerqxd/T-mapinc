...
import { MarkerData, Review } from '@/lib/types';
...
export default function Home() {
  ...
  const { markers, reviews, addMarkerWithReview, addReview, updateReview, deleteReview, deleteMarker } = useMarkers();
  ...
  const handleCreateMarkerWithReview = async (reviewData: Omit<Review, 'id' | 'createdAt' | 'updatedAt'| 'authorId' | 'markerId' | 'authorName' | 'authorAvatarUrl'>) => {
    if (newMarkerCoords) {
