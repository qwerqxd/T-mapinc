...
export default function Home() {
  ...
  // Получение уникальных категорий с помощью useMemo для предотвращения бесконечного цикла
  const categories = useMemo(() => {
    return Array.from(new Set(markers.map(marker => marker.category).filter(Boolean)));
  }, [markers]);
